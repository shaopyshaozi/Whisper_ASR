    ...
    def build_split(self, split: SplitConfig) -> None:
        ...
        while items_written < split.num_items:
            ...
            for spk_idx in range(cfg.n_speakers):
                ...
                mic_name = f"mic_fileid_{scene_id}_doa{doa}_6spk.wav"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_root", type=str, default=r"D:\邵鹏远\UCL\博1\code\Whisper ASR\data\dataset_3mic_6spk", help="Output dataset root")
